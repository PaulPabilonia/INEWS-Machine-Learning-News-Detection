              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form className="space-y-4 md:space-y-3" onSubmit={handleSubmit}>
                  ...
                  >Already Have an account? <Link to="/SignIn"
                    className="text-primary-600 hover:underline dark:text-primary-500 font-medium inline-flex space-x-1 items-center"><span> Sign In Here </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
