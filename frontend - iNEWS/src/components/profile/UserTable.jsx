        ...
        {(allUser.map((user) => (
          <tr className="border-b border-gray-600 hover:bg-gray-700">
            ...
            <td className="py-3 px-6 text-left">
              <div className="flex items-center">
                <div className="mr-2">
                  <img className="w-6 h-6 rounded-full border-gray-200 border transform hover:scale-125" src={userImage} />
                </div>
            ...
            <td className="py-3 px-6 text-center">
              {user.is_active ?
                <span className="bg-green-700 text-green-100 py-1 px-3 rounded-full text-xs">Active</span> :
                <span className="bg-red-700 text-red-100 py-1 px-3 rounded-full text-xs">Unactive</span>
              }
